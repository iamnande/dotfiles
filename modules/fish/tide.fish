...
set -g tide_pwd_markers .bzr .citc .git .hg .node-version .python-version .ruby-version .shorten_folder_marker .svn .terraform .tool-versions Cargo.toml composer.json CVS go.mod package.json
...
set -g tide_right_prompt_items status cmd_duration context jobs direnv bun nix_shell time
